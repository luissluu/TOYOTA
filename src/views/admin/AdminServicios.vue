// src/views/admin/AdminServicios.vue
<template>
  <div class="flex flex-col w-full px-6">
    <section class="grid grid-cols-1 gap-8 px-8 md:grid-cols-1">
      <div class="bg-gray-800 md:col-span-1">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h2 class="text-2xl font-bold tracking-tight text-white">Gestión de Servicios</h2>
          
          <!-- Contenido de gestión de servicios -->
          <div class="mt-6 bg-gray-700 rounded-lg p-6">
            <div class="flex justify-between items-center mb-6">
              <div class="relative flex-grow max-w-sm">
                <input type="text" placeholder="Buscar servicio..." class="w-full rounded-md bg-gray-600 border-gray-500 text-white px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
              ...
              <table class="min-w-full bg-gray-600 rounded-lg overflow-hidden">
                <thead class="bg-gray-700">
                  <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Disponible</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Acciones</th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-gray-500">
                  <!-- Ejemplo de fila de servicio -->
                  <tr class="hover:bg-gray-500">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-white">#001</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-white">Cambio de aceite y filtro</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-white">Mantenimiento básico</td>
                  ...
                  <!-- Más filas de servicios -->
                  <tr class="hover:bg-gray-500">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-white">#002</td>
                  ...
                  <tr class="hover:bg-gray-500">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-white">#003</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-white">Cambio de bujías</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-white">Sistema de motor</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-white">$850</td>
                    <td class="px-6 py-4 whitespace-nowrap">
            ...
            <div class="flex justify-between items-center mt-6">
              <div class="text-sm text-gray-400">
                Mostrando 1-3 de 27 resultados
              </div>
